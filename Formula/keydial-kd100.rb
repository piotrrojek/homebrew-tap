# Homebrew formula for keydial-kd100 — the live tap copy.
# Source of truth for the template lives in the project repo at
# packaging/keydial-kd100.rb; on each release, fill in url + sha256 here from the
# workflow's "Print Homebrew SHA256" step.
#
# kd100 is a menu-bar (tray) app, not a brew-services daemon — there is no
# `service` block.
#
...
class KeydialKd100 < Formula
  ...
  url "https://github.com/piotrrojek/keydial-kd100/releases/download/v0.6.0/keydial-kd100-0.6.0-macos-universal.tar.gz"
  sha256 "e607c0331964ab8935b10c542b143f363a3059e360bc2ededaec70e780961053"
  version "0.6.0"
  license "MIT"
